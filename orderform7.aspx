<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderform7.aspx.cs" Inherits="orderform7" %>
...
&nbsp;<div class="clear"></div>
            ...
            <div class="order-list">
               ...
               <div class="main">
                 ...
                 <asp:ListItem  Text="OVAL SHAPED RUBBER STAMP"></asp:ListItem>
                  <asp:ListItem  Text="RECTANGLED SHAPED RUBBER STAMP"></asp:ListItem>
                  <asp:ListItem  Text="ORGANIC CERTIFICATE RUBBER STAMP"></asp:ListItem>
                  <asp:ListItem  Text="FONTED SLIM RUBBER STAMP"></asp:ListItem>
                  <asp:ListItem  Text="FONTED THICK RUBBER STAMP"></asp:ListItem>
                  <asp:ListItem  Text="MAT COLOURFUL OUTLOOK RUBBER STAMP"></asp:ListItem>
