<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderform2.aspx.cs" Inherits="orderform2" %>
...
&nbsp;<div class="clear"></div>
            ...
            <div class="order-list">
               ...
               <div class="main">
                 ...
                 <asp:ListItem  Text="SIMPLE LETTERHEAD"></asp:ListItem>
                  <asp:ListItem  Text="IMAGE LETTERHEAD"></asp:ListItem>
                  <asp:ListItem  Text="DOUBLE COLOUR LETTERHEAD"></asp:ListItem>
                  <asp:ListItem  Text="SINGLE BOUNDARY LETTERHEAD"></asp:ListItem>
                  <asp:ListItem  Text="CENTRE IMAGE LETTERHEAD"></asp:ListItem>
                  <asp:ListItem  Text="SHADING BASED LETTERHEAD"></asp:ListItem>
