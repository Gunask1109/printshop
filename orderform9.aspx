<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderform9.aspx.cs" Inherits="orderform9" %>
...
&nbsp;<div class="clear"></div>
            ...
            <div class="order-list">
               ...
               <div class="main">
                 ...
                 <asp:ListItem  Text="WIND RESISTANT"></asp:ListItem>
                  <asp:ListItem  Text="DOUBLE SIDED STANDEE"></asp:ListItem>
                  <asp:ListItem  Text="ROLL UP"></asp:ListItem>
                  <asp:ListItem  Text="MULTI COLOUR PREMIUM STANDEE"></asp:ListItem>
                  <asp:ListItem  Text="TABLE TOP STANDEE"></asp:ListItem>
                  <asp:ListItem  Text="FLEX BANNER"></asp:ListItem>
            ...
            <div class="order-list">
               ...
               <div class="main">
                  ...
                  <asp:ListItem  Text="----Select Product---"></asp:ListItem>
                  <asp:ListItem  Text="SIMPEL STICKER"></asp:ListItem>
                  <asp:ListItem  Text="NAME TAG STICKER"></asp:ListItem>
                  <asp:ListItem  Text="OVAL STICKER"></asp:ListItem>
                  <asp:ListItem  Text="AGS LABEL STICKER"></asp:ListItem>
                  <asp:ListItem  Text="CD STICKER"></asp:ListItem>
                  <asp:ListItem  Text="WATERPROOF STICKER"></asp:ListItem>
