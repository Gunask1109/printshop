<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderform6.aspx.cs" Inherits="orderform6" %>
...
&nbsp;<div class="clear"></div>
            ...
            <div class="order-list">
               ...
               <div class="main">
                 ...
                 <asp:ListItem  Text="SIMPEL DESIGNED CERTIFICATE"></asp:ListItem>
                  <asp:ListItem  Text="EDGE DESIGNED CERTIFICATE"></asp:ListItem>
                  <asp:ListItem  Text="TOP & BOTTOM DESIGNED CERTIFICATE"></asp:ListItem>
                  <asp:ListItem  Text="FRAMING PATTERN CERTIFICATE"></asp:ListItem>
                  <asp:ListItem  Text="TOP DESIGNED CERTIFICATE"></asp:ListItem>
                  <asp:ListItem  Text="COLOURFUL BORDERED CERTIFICATE"></asp:ListItem>
