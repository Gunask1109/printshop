<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form.aspx.cs" Inherits="Admin_examples_form" %>
        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="tables.aspx">
              ...
              <%--<asp:HyperLink ID="Tablelist" runat="server" Text="Table List"></asp:HyperLink>--%>
              <p>Table List</p>
            </a>
          </li>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Button ID="Button1" runat="server" BackColor="#FF6600" BorderColor="Black" 
                          Height="39px"  style="margin-left: 133px" Text="Submit" 
