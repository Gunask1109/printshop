<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashboard.aspx.cs" Inherits="Admin_examples_dashboard" %>
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-12">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false"   
                    ...
                    CellPadding="3"  DataTextField="Title" Width="100%" GridLines="Vertical" >  
            ...
            <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
                    ...
                    <%-- <asp:TemplateField HeaderText="productid" >  
                        ...
                        <asp:TemplateField HeaderText="DealerName">  
                            <EditItemTemplate>  
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("DealerName") %>'></asp:TextBox>  
                            </EditItemTemplate>  
                            <ItemTemplate>  
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right" id="date">
            ...
            <a href="dashboard.aspx" target="_blank">JJ-Printer</a> for a better web.
          </div>
        </div>
      </footer>
      <script>
