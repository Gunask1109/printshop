<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderform8.aspx.cs" Inherits="orderform8" %>
...
&nbsp;<div class="clear"></div>
            ...
            <div class="order-list">
               ...
               <div class="main">
                 ...
                 <asp:ListItem  Text="ARTING & DESIGNED MUGS"></asp:ListItem>
                  <asp:ListItem  Text="PHOTO ON MUGS"></asp:ListItem>
                  <asp:ListItem  Text="COLLAGING ON MUGS"></asp:ListItem>
                  <asp:ListItem  Text="SKETCHING ON MUGS"></asp:ListItem>
                  <asp:ListItem  Text="COLOURFUL THOUGHT ON MUGS"></asp:ListItem>
                  <asp:ListItem  Text="TRANSPARENCY OF IMAGE ON MUGS"></asp:ListItem>
